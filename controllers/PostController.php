        ...
        if (Rays::isPost()) {
            ...
            if (isset($form['replyTo'])) {
                ...
                Message::sendMessage(
                    ...
                    $exactComment->userId,
                    'New reply',
                    $user->name . ' has replied to your comment ' . RHtml::linkAction('post', $topic->title, 'view', $topic->id . '?reply=' . $cid)
                );
            }
                ...
                Message::sendMessage(
                    ...
                    $user->name . ' has replied to your topic ' . RHtml::linkAction('post', $topic->title, 'view', $topic->id . '?reply=' . $cid)
                );
            }
        }
        $this->redirectAction('post', 'view', $topicId);
