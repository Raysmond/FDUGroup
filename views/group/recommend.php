<?=RForm::openForm('group/recommend',array('id'=>'recommendGroupForm'))?>
<div class="panel panel-default">
    <div class="panel-heading">
        <b>Group recommendation</b>
        <div style="float: right;">
            <?=RForm::input(array('type'=>'submit','class'=>'btn btn-xs btn-info','value'=>'Recommend'))?>
        </div>
    </div>
    <div class="panel-body">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <a href="javascript:search_groups()" search_url="<?=RHtml::siteUrl('group/recommend')?>" class="btn btn-sm btn-info">Search</a>
                            </div>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <a href="javascript:search_users()" search_url="<?=RHtml::siteUrl('group/recommend')?>" class="btn btn-sm btn-info">Search</a>
                            </div>
                        </div>
                        <div class="row" style="padding: 10px;">
                            <b>Selected users</b>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php
                    $self->module("ckeditor",array('editorId'=>'recommend-words','name'=>'recommend-words'));
                ?>
            </div>
        </div>
