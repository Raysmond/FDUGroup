 ...
 */
?>
<?=RForm::openForm('group/admin',array('id'=>'groupAdminForm'))?>
<div class="panel panel-default">
    <!-- Default panel contents -->
    <div class="panel-heading">
        <div class="heading-actions">
            <div class="input-group" style="margin-top: -6px;">
                <?=RForm::input(array('name'=>'search','class'=>'form-control','style'=>'width:200px;','placeholder'=>'filter groups','value'=>(isset($filterStr)?$filterStr:"")))?>
    ...
    <div class="panel-body">
        ...
        <table id="admin-users" class="table">
            ...
            <tr>
                ...
                ?>
                <th><a class="highlight" href="<?=RHtml::siteUrl("group/admin?orderBy=id&&order=".$order)?>">
                ...
                <th><a class="highlight" href="<?=RHtml::siteUrl("group/admin?orderBy=memberCount&&order=".$order)?>">
                ...
                <th><a class="highlight" href="<?=RHtml::siteUrl("group/admin?orderBy=createTime&&order=".$order)?>">
                ...
                <th><a class="highlight" href="<?=RHtml::siteUrl("group/admin?orderBy=views&&order=".$order)?>">
                ...
                <th><a class="highlight" href="<?=RHtml::siteUrl("group/admin?orderBy=likes&&order=".$order)?>">
