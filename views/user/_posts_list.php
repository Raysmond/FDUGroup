    ...
    foreach ($topics as $topic) {
        ...
        <div class="row topic-item">
            ...
            <div class="col-lg-10 topic-content">
                ...
                <div class="inner">
                    <div class="topic-title"><?= RHtml::linkAction('post', $topic->title, 'view', $topic->id) ?></div>

                    <!-- Topic meta info -->
                    <div class="topic-meta">
                        <?= RHtml::linkAction('user', $topic->user->name, 'view', $topic->user->id) ?>
                        post
                        in <?= RHtml::linkAction('group', $topic->group->name, 'detail', $topic->group->id) ?>
...
//                    $interval = $now->diff($time);
                    ...
                    <div class="actions">
                        <a href="<?=RHtml::siteUrl('post/view/'.$topic->id).'#reply'?>">
