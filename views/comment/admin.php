<?= RForm::openForm('comment/admin', array('id' => 'commentAdminForm')) ?>
...
<?php
    //$ajax = new RAjaxHelper('ajax_delete_comment','Ajax delete',RHtml::siteUrl('comment/admin'),'POST',array('page'=>'1','pagesize'=>5),'before_delete','after_delete',array('class'=>'ajax_delete','title'=>'Ajax delete'));
    //echo $ajax->html();
?>