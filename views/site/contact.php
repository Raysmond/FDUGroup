    ...
    <div class="panel-body site-hook" id="developers-list">
        ...
        <div class="user-item col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="https://github.com/Raysmond/" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/ljk.jpg'?>" class="img-thumbnail" title="Raysmond">
            </a>
            <a title="admin" href="https://github.com/Raysmond/" target="_blank">Raysmond</a>
        </div>
        <div class="user-item col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="https://github.com/RenchuSong/" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/src.jpg'?>"class="img-thumbnail"  title="Renchu Song">
            </a>
        ...
        <div class="user-item col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="https://github.com/wishstudio/" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/sxy.jpg'?>"class="img-thumbnail"  title="wishstudio">
            </a>
            <a title="admin" href="https://github.com/wishstudio/" target="_blank">wishstudio</a>
        </div>
        <div class="user-item col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="https://github.com/junshiguo/" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/gjs.jpg'?>"class="img-thumbnail"  title="junshiguo">
            </a>
        ...
        <div class="user-item  col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="https://github.com/zyz282994112/" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/zyz.jpg'?>" class="img-thumbnail"  title="zyz282994112">
            </a>
            <br/>
        ...
        <div class="user-item col-lg-3" style="overflow: hidden;text-align: center;">
            <a href="http://www.renren.com/284019636/profile" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/wjh.jpg'?>" class="img-thumbnail"  title="Junhao Wu">
            </a>
            <br/>
        ...
        <p>
            <?=RHtml::link("FDUGroup github page",$githubLink,$githubLink);?>
        </p>
        <div class="user-item" style="overflow: hidden;text-align:left;">
            <a href="<?=$githubLink?>" target="_blank">
                <img src="<?=RHtml::siteUrl('public/images').'/QuickMark.png'?>" title="Scan This!" />
            </a>
        </div>
    </div>
</div>