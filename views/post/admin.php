<?= RForm::openForm('post/admin', array('id' => 'topicsAdminForm')) ?>
        ...
        <div class="panel-body">
            <table id="admin-topics" class="table">
                ...
                <tr>
                    ...
                    <th><a class="highlight" href="<?=RHtml::siteUrl("post/admin?orderBy=createTime&&order=".$order)?>">
                    ...
                    <th><a class="highlight" href="<?=RHtml::siteUrl("post/admin?orderBy=replies&&order=".$order)?>">
                    ...
                    <th><a class="highlight" href="<?=RHtml::siteUrl("post/admin?orderBy=views&&order=".$order)?>">
                    ...
                    <th><a class="highlight" href="<?=RHtml::siteUrl("post/admin?orderBy=likes&&order=".$order)?>">
                ...
                foreach ($topics as $topic) {
                    echo '<tr>';
                    echo '<td>' . RForm::input(array('type' => 'checkbox', 'name' => 'checked_topics[]', 'value' => $topic->id)) . '</td>';
                    echo '<td>' . RHtml::linkAction('user', $topic->user->name, 'view', $topic->user->id) . '</td>';
                    echo '<td>' . RHtml::linkAction('post', $topic->title, 'view', $topic->id) . '</td>';
                    echo '<td>' . RHtml::linkAction('group', $topic->group->name, 'detail', $topic->group->id) . '</td>';
