...
<head>
    ...
    <meta name="description" content="FDUGroup, website of interest groups!"/>
...
<div id="main-wrapper" class="container">
    <?php
    $self->module("group_categories", array('name' => "Categories"));
    $self->module("posts_category");
    ?>
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <?php
            $self->module("follow_us");
            $self->module("help_nav");
            //$self->module("contact_nav");

            $self->module("active_groups");
            $self->module("hot_posts");
            $self->module("friend_groups", array('id' => 'friend_groups', 'name' => "Friend Groups"));
            $self->module("group_users", array('id' => 'group_users', 'name' => "Group Users"));
            $self->module("ads", array('id' => 'ads', 'name' => "Ads"));
