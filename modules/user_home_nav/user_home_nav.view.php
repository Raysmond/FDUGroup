<div class="user-home-navigation">
    <ul class="nav nav-pills nav-stacked">
        ...
        if (($count = $user->countUnreadMsgs()) == 0) {
            ...
            ?>
            <a href="<?=RHtml::siteUrl('message/view')?>"><span class="glyphicon glyphicon-envelope"></span> &nbsp; Messages</a>
            <?php
            echo "</li>";
        } else {
