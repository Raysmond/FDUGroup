...
class DataConnector
{
    ...
    public static function getConnection()
    {
        if (self::$connection == null) {
            self::$connection = mysql_connect(Constant::db_host, Constant::db_user, Constant::db_password) or die(mysql_error());
            mysql_select_db(Constant::db_name) or die(mysql_error());
            mysql_query("set names " . Constant::db_charset) or die(mysql_error());
        }
